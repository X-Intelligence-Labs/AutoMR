...
shrec_train = Shrec2021Dataset(
    ...
    window_size=250,
    stride=64,
    annotation_path='shrec/annotation_shrec2021_train.txt'  # Provide label file path
)
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.time_warp:
            d = self.augmentor.time_warp(d)  # call time_warp function
