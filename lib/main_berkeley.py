...
berkeley_train = mhealth_dataset(
    ...
    window_size=15,
    stride=7,
    annotation_path='berkeley/clean_data/y_train.txt'  # Provide annotation file path
)
...
berkeley_test = mhealth_dataset(
    ...
    window_size=15,
    stride=7,
    annotation_path='berkeley/clean_data/y_test.txt'  # Provide annotation file path
)
